...
class CanvasHome extends Component {
  ...
  setupCamera = () => {
    ...
    this.camera = new THREE.PerspectiveCamera(
      45,
      this.WNDSIZE.width / this.WNDSIZE.height,
      0.1,
      1000
    );
  ...
  draw = () => {
    ...
    const material_L1 = new THREE.MeshBasicMaterial({
  ...
  handleFemCentre = (event) => {
    ...
    this.landmark_1.material.color.set("green");
  ...
  handleHipCentre = () => {
    ...
    this.landmark_2.material.color.set("green");
